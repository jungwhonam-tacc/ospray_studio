...
RequestManager::RequestManager(std::string configFilePath) {
    ...
    try {
        ...
        if (configFile)
            ...
            std::cerr << "The voice config file does not exist." << std::endl;
    } catch (nlohmann::json::exception &e) {
        std::cerr << "Failed to parse the voice config file: " << e.what() << std::endl;
    }
...
// show "important" voice information in a readable format
